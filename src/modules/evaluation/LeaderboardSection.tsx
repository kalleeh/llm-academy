...
const PROBLEMS: { label: LabelKey; icon: IconName; desc: string; example: string }[] = [
...
export const LeaderboardSection: React.FC = () => {
  ...
  const c = t.modules.evaluation.leaderboardSection
  ...
  return (
    <section aria-labelledby="leaderboard-problem">
        ...
        {PROBLEMS.map((p, i) => (
          <div key={i} className="rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 overflow-hidden">
            ...
            >
              ...
              <span className="font-medium text-zinc-900 dark:text-zinc-100">{t.labels[p.label]}</span>
      ...
      <div className="rounded-lg border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 p-5">
        <h3 className="mb-3 font-mono text-sm font-semibold text-zinc-900 dark:text-zinc-100">{c.arenaHeading}</h3>
        <p className="mb-3 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">{c.arenaIntro}<strong className="text-zinc-900 dark:text-zinc-100">blind human
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-md bg-green-500/10 p-3">
            ...
            <p className="mt-1 text-sm text-zinc-700 dark:text-zinc-300">{c.arenaWorks}</p>
          </div>
          <div className="rounded-md bg-red-500/10 p-3">
            <span className="text-xs font-medium text-red-400">✗ Limitations</span>
            <p className="mt-1 text-sm text-zinc-700 dark:text-zinc-300">{c.arenaLimits}</p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-4 rounded-lg border border-amber-500/20 bg-amber-500/5 p-4">
        <p className="text-sm text-amber-200/90">
          <strong>Bottom line:</strong>{c.bottomLine}<em> your specific use case</em> with your own eval set. No leaderboard can tell you
