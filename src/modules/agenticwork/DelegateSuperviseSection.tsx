...
import { WorkAppWindow, type WorkStep } from '../../components/WorkAppWindow'
...
export const DelegateSuperviseSection: React.FC = () => {
  ...
  return (
    <section aria-labelledby="delegate-supervise">
      ...
      >
        {(id) => <WorkAppWindow key={id} variant={id as 'quick-desktop' | 'cowork'} steps={c.steps as unknown as WorkStep[]} kinds={KINDS} />}
      </AppSession>
