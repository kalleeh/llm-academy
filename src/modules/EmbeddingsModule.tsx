...
const BUSINESS_QUESTIONS: Question[] = [
  ...
  { id: 'emb-biz-3', type: 'mc', question: 'You upload a PDF to ChatGPT and ask questions about it. Is this RAG?', options: ['Yes — any time AI reads a document, that\'s RAG', 'No — the file is put directly into the conversation context, not indexed and searched. It\'s more like handing someone a printout.', 'Only if the PDF is longer than 10 pages', 'It depends on which AI model you use'], correctIndex: 1, explanation: 'Uploading a file to a chat puts it directly into the conversation context — the AI reads the whole thing (or tries to). RAG is different: documents are indexed, chunked, and searched so the AI only retrieves the relevant parts. Knowledge base features (like ChatGPT Projects or Amazon Q Business) are actual RAG.' },
]
