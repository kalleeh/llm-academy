            ...
            {expanded === i && (
              <div className="space-y-3 border-t border-zinc-800 px-5 py-4 text-sm">
                <div>
                  ...
                  <p className="text-zinc-300" dangerouslySetInnerHTML={{ __html: concept.whatItIs }} />
                </div>
                <div>
                  <p className="mb-1 text-xs font-medium text-zinc-500">Where you&apos;ll see it in real life</p>
                  <p className="text-zinc-300" dangerouslySetInnerHTML={{ __html: concept.whereYouSeeIt }} />
                </div>
                <div>
                  <p className="mb-1 text-xs font-medium text-amber-300">Do you need to do anything?</p>
                  <p className="text-zinc-300" dangerouslySetInnerHTML={{ __html: concept.doIneedToDoSomething }} />
                </div>
                <div>
                  <p className="mb-1 text-xs font-medium text-emerald-400">Why you should care</p>
                  <p className="text-zinc-300" dangerouslySetInnerHTML={{ __html: concept.whyCare }} />
                </div>
                <div className="rounded-md border border-zinc-700 bg-zinc-900 p-3">
                  ...
                  <p className="text-zinc-300" dangerouslySetInnerHTML={{ __html: concept.example }} />
                </div>
              </div>
            )}
          </div>
