...
const CONCEPTS: Concept[] = [
  { name: 'MCP — connecting to tools', analogy: 'Universal access badges for your systems', whatItIs: 'An open standard (the "USB-C of AI") that lets any AI connect to any tool through one universal protocol. Over 2,000 connectors already exist.', example: 'Your company builds an MCP server for your ticketing system. Now every AI tool in the company can create, read, and update tickets — without building separate integrations for each one.', color: 'border-emerald-500/30 bg-emerald-500/5' },
  ...
  { name: 'A2A — agents talking to agents', analogy: 'Departments sending requests to each other', whatItIs: 'While MCP connects agents to tools, A2A connects agents to OTHER agents. Created by Google and backed by 150+ organizations.', example: 'Your support agent detects a billing issue. Via A2A, it sends a refund request to the finance team\'s billing agent.', color: 'border-cyan-500/30 bg-cyan-500/5' },
]
